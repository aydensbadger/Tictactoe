...
def medium_com(com, board):
    ...
    while True:
        ...
        if board == [[0, 0, 0], [0, 0, 0], [0, 0, 0]]:
            if num == 1: 
                board[0][1] = com
            elif num == 2: board[1][0] = com
            elif num == 3: board[1][2] = com
            elif num == 4: board[2][1] = com
            return board
        ...
        if num2 == 1 and top_L_open: 
            board[0][0] = com

            return board

        if num2 == 2 and top_open: 
            board[0][1] = com

            return board

        if num2 == 3 and top_R_open: 
            board[0][2] = com

            return board
            
        if num2 == 4 and left_open: 
            board[1][0] = com
        
            return board

        if num2 == 5 and middle_open: 
            board[1][1] = com

            return board

        if num2 == 6 and right_open: 
            board[1][2] = com

            return board

        if num2 == 7 and bottem_L_open: 
            board[2][0] = com

            return board

        if num2 == 8 and bottem_open: 
            board[2][1] = com

            return board

        if num2 == 9 and bottem_R_open:
            board[2][2] = com
...
def medium(surface, player):
    ...
    medium_label = Label(medium_img, 5.4)
    ...
    medium_label.draw(528, 5, surface)
    ...
    if player == 1:
        score_editor('plus', 18)
        
    else: 
        score_editor('plus', 19)
                ...
                for i in row:
                    if i != 0:
                        ...
                        if c == 9:
                            ...
                            score_editor('plus', 2)
                            score_editor('plus', 16)

                            backround_tie_label.draw(210, 140, surface)
                            tie_label.draw(250, 160, surface)
